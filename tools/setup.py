...
def main():
    ...
    print("""
  ######################################
  # FR4 Development Environment Setup #
  ######################################

  This script will create your FR4 dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your FR4 project folder:
    [Arma 3 installation directory]\\{} => FR4 project folder
    P:\\{}                              => FR4 project folder
